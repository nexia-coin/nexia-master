...
"""Verify that starting nexia with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nexia with -h for help text")
        ...
        self.log.info("Start nexia with -version for version information")
        ...
        self.log.info("Start nexiad with -fakearg to make sure it does not start")
