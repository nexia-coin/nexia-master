Contributing to Nexia Core
============================

The Nexia Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Nexia Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/nexia-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to nexia-qt
...
The following applies to code changes to the Nexia Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Nexia
Network Protocol consensus changes.

Whether a pull request is merged into Nexia Core rests with the project merge
...
Patches that change Nexia consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nexia consensus, it must have been
...
The project leader is the release manager for each Nexia Core release.
