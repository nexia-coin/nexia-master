...
const char * const BITCOIN_CONF_FILENAME = "nexia.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Nexia";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Nexia";
#else
    // Unix-like
    return pathRet / ".nexia";
#endif
#endif
}
