...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nexia-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nexia-tx [options] <hex-tx> [commands]  Update hex-encoded nexia transaction\n" +
            "or:     nexia-tx [options] -create [commands]   Create hex-encoded nexia transaction\n" +
            "\n";
