...
bech32_templates = [
  ...
  ('nxe',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('nxe',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('nxe',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('nxe',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tnxe',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tnxe',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tnxe',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tnxe',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tnxe',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tnxe',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tnxe',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tnxe',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rnxe',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rnxe',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rnxe',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rnxe', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tnxe',   17, 32, Encoding.BECH32M, False, False, False),
  ('rnxe',  3,  1, Encoding.BECH32M, False, False, False),
  ('nxe',   15, 41, Encoding.BECH32M, False, False, False),
  ('tnxe',    0, 16, Encoding.BECH32,  False, False, False),
  ('rnxe',  0, 32, Encoding.BECH32,  True,  False, False),
  ('nxe',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tnxe',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rnxe',  0, 20, Encoding.BECH32,  False, False, True),
  ('nxe',    0, 20, Encoding.BECH32M, False, False, False),
  ('tnxe',    0, 32, Encoding.BECH32M, False, False, False),
  ('rnxe',  0, 20, Encoding.BECH32M, False, False, False),
  ('nxe',    1, 32, Encoding.BECH32,  False, False, False),
  ('tnxe',    2, 16, Encoding.BECH32,  False, False, False),
  ('rnxe', 16, 20, Encoding.BECH32,  False, False, False),
]
